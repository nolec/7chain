...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = 'Scripts/pdf.js/build/pdf.worker.js';
  PDFJS.cMapUrl = 'Scripts/pdf.js/web/cmaps/';
...
function webViewerLoad() {
  ...
  var getFilename = getParameterByName('file');
  var getLanguage = getParameterByName('lang');

    if (getFilename == 'white-paper') {
        if (getLanguage == 'kr')
            config.defaultUrl = 'Docs/7Chain_WhitePaper_KR.pdf';
        else if (getLanguage == 'en')
            config.defaultUrl = 'Docs/7Chain_WhitePaper_EN.pdf';
        else if (getLanguage == 'cn')
            config.defaultUrl = 'Docs/7Chain_WhitePaper_CN.pdf';
        else if (getLanguage == 'jp')
            config.defaultUrl = 'Docs/7Chain_WhitePaper_JP.pdf';
    }
  else if (getFilename == 'user-terms')
    config.defaultUrl = 'Docs/User_Terms_7Chain.pdf';
  else if (getFilename == 'privacy-policy')
    config.defaultUrl = 'Docs/Privacy_Policy_7Chain.pdf';
